...
def ocp_to_bvp(ocp, guess):
    ...
    out['problem_data'] = {'method': 'brysonho',
       ...
       'state_list': [str(x) for x in reduced_states],
       'deriv_list': [tf_var * eom for eom in equations_of_motion_list],
       'quad_list': [tf_var * quad for quad in quadratures_list],
       'states': states,
       'costates': costates,
       'constants': constants,
       'constants_of_motion': constants_of_motion,
       'dynamical_parameters': [tf_var] + dynamical_parameters,
