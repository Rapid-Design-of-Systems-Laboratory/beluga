...
# -*- coding: utf-8 -*-
#
# beluga documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'beluga.tex', 'beluga Documentation',
...
man_pages = [
    (master_doc, 'beluga', 'beluga Documentation',
     [author], 1)
]
