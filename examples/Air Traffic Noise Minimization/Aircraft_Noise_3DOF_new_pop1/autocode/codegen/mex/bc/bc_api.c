 ...
 * bc_api.c
 *
 * Code generation for function 'bc_api'
 *
...
static void b_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, real_T (**y_data)[12], int32_T y_size[1]);
static const mxArray *b_emlrt_marshallOut(real_T u[25]);
...
static void e_emlrt_marshallIn(const mxArray *b_const, const char_T *identifier,
  struct_T *y);
static void emlrt_marshallIn(const mxArray *YL, const char_T *identifier, real_T
                             (**y_data)[12], int32_T y_size[1]);
...
static real_T g_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId);
static void h_emlrt_marshallIn(const mxArray *constraint, const char_T
  *identifier);
...
static real_T j_emlrt_marshallIn(const mxArray *arcSequence, const char_T
  *identifier);
...
static void o_emlrt_marshallIn(const mxArray *src, const emlrtMsgIdentifier
  *msgId, real_T (**ret_data)[12], int32_T ret_size[1]);
...
static void b_info_helper(ResolvedFunctionInfo info[95])
{
  ...
  info[90].context =
    "[E]/home/mall/mjgrant/trajProblems/Friends/Janav/Aircraft_Noise_3DOF_new_pop1/autocode/bc.m";
  info[90].name = "mtimes";
  ...
  info[91].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  info[91].fileTimeLo = 1343851986U;
  ...
  info[92].fileTimeLo = 1286840442U;
  info[92].fileTimeHi = 0U;
  info[92].mFileTimeLo = 0U;
  info[92].mFileTimeHi = 0U;
  info[93].context =
    "[E]/home/mall/mjgrant/trajProblems/Friends/Janav/Aircraft_Noise_3DOF_new_pop1/autocode/bc.m";
  info[93].name = "mrdivide";
  info[93].dominantType = "double";
  info[93].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[93].fileTimeLo = 1357973148U;
  info[93].fileTimeHi = 0U;
  info[93].mFileTimeLo = 1319751566U;
  info[93].mFileTimeHi = 0U;
  info[94].context =
    "[E]/home/mall/mjgrant/trajProblems/Friends/Janav/Aircraft_Noise_3DOF_new_pop1/autocode/bc.m";
  info[94].name = "cos";
  info[94].dominantType = "double";
  info[94].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  info[94].fileTimeLo = 1343851972U;
  ...
  real_T (**y_data)[19], int32_T y_size[1])
{
  ...
  thisId.fParent = NULL;
  d_emlrt_marshallIn(emlrtAlias(p), &thisId, y_data, y_size);
  emlrtDestroyArray(&p);
}
...
static void d_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, real_T (**y_data)[19], int32_T y_size[1])
{
  p_emlrt_marshallIn(emlrtAlias(u), parentId, y_data, y_size);
  emlrtDestroyArray(&u);
}
  ...
  struct_T *y)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  f_emlrt_marshallIn(emlrtAlias(b_const), &thisId, y);
                             ...
                             (**y_data)[12], int32_T y_size[1])
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  b_emlrt_marshallIn(emlrtAlias(YL), &thisId, y_data, y_size);
  emlrtDestroyArray(&YL);
}
  ...
  *parentId, struct_T *y)
{
  ...
  y->Aref = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "Aref")), &thisId);
  thisId.fIdentifier = "C1";
  y->C1 = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "C1")), &thisId);
  thisId.fIdentifier = "C2";
  y->C2 = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "C2")), &thisId);
  thisId.fIdentifier = "H";
  y->H = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal, u,
    0, "H")), &thisId);
  thisId.fIdentifier = "Tmax";
  y->Tmax = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "Tmax")), &thisId);
  thisId.fIdentifier = "Tmin";
  y->Tmin = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "Tmin")), &thisId);
  thisId.fIdentifier = "alfamax";
  y->alfamax = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a
    (emlrtRootTLSGlobal, u, 0, "alfamax")), &thisId);
  thisId.fIdentifier = "bankmax";
  y->bankmax = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a
    (emlrtRootTLSGlobal, u, 0, "bankmax")), &thisId);
  thisId.fIdentifier = "epsilon";
  y->epsilon = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a
    (emlrtRootTLSGlobal, u, 0, "epsilon")), &thisId);
  thisId.fIdentifier = "g";
  y->g = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal, u,
    0, "g")), &thisId);
  thisId.fIdentifier = "mass";
  y->mass = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "mass")), &thisId);
  thisId.fIdentifier = "mu";
  y->mu = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "mu")), &thisId);
  thisId.fIdentifier = "re";
  y->re = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "re")), &thisId);
  thisId.fIdentifier = "rho0";
  y->rho0 = g_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2013a(emlrtRootTLSGlobal,
    u, 0, "rho0")), &thisId);
  emlrtDestroyArray(&u);
}
  ...
  *identifier)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  i_emlrt_marshallIn(emlrtAlias(constraint), &thisId);
  ...
  *identifier)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  y = g_emlrt_marshallIn(emlrtAlias(arcSequence), &thisId);
  emlrtDestroyArray(&arcSequence);
  return y;
}
  ...
  *msgId, real_T (**ret_data)[12], int32_T ret_size[1])
{
  ...
  emlrtCheckVsBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", FALSE, 1U,
    iv3, bv0, iv4);
  ret_size[0] = iv4[0];
  *ret_data = (real_T (*)[12])mxGetData(src);
  ...
  msgId))[6]
{
  ...
  void bc_api(const mxArray * const prhs[10], const mxArray *plhs[1])
{
  real_T (*zeroVec)[25];
  int32_T YL_size[1];
  real_T (*YL_data)[12];
  ...
  real_T (*x0)[6];
  real_T (*xf)[6];
  zeroVec = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));

  /* Marshall function inputs */
  emlrt_marshallIn(emlrtAlias(prhs[0]), "YL", &YL_data, YL_size);
  emlrt_marshallIn(emlrtAlias(prhs[1]), "YR", &YR_data, YR_size);
  c_emlrt_marshallIn(emlrtAlias(prhs[2]), "p", &p_data, p_size);
  e_emlrt_marshallIn(emlrtAliasP(prhs[3]), "const", &b_const);
  h_emlrt_marshallIn(emlrtAliasP(prhs[4]), "constraint");
  arcSequence = j_emlrt_marshallIn(emlrtAliasP(prhs[5]), "arcSequence");
  ...
  bc(*YL_data, YL_size, *YR_data, YR_size, *p_data, p_size, &b_const,
     arcSequence, *x0, *xf, *zeroVec);

  /* Marshall function outputs */
  plhs[0] = b_emlrt_marshallOut(*zeroVec);
}
...
/* End of code generation (bc_api.c) */
