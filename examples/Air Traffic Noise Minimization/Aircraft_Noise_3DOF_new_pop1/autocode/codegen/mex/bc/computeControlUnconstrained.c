...
void computeControlUnconstrained(const real_T xAndLambda[12], real_T const_C1,
  real_T const_C2, real_T const_alfamax, real_T const_bankmax, real_T const_g,
  real_T const_mass, real_T *banktrigSave, real_T *alfatrigSave, real_T
  *TtrignewSave, real_T *hamiltonianSave)
{
  ...
  *TtrignewSave = 1.5707963267948966;
  ...
  ar = (const_C1 * (xAndLambda[3] * xAndLambda[3]) + v.re) - muDoubleScalarCos
    (-const_alfamax) * 3420.0;
  ai = const_C1 * (xAndLambda[3] * 0.0 + 0.0 * xAndLambda[3]) + v.im;
  if (ai == 0.0) {
  ...
  ai = const_g * dc3.im;
  if (ai == 0.0) {
    const_g_re = ar / xAndLambda[3];
    const_g_im = 0.0;
  } else if (ar == 0.0) {
    const_g_re = 0.0;
    const_g_im = ai / xAndLambda[3];
  } else {
    const_g_re = ar / xAndLambda[3];
    const_g_im = ai / xAndLambda[3];
  }

  b_const_mass.re = const_mass * xAndLambda[3];
  ...
  hamiltonian = const_mass * xAndLambda[3];
  ...
  ar = muDoubleScalarSin(-const_bankmax) * xAndLambda[10] * (const_g *
  ...
  *hamiltonianSave = ((((((xAndLambda[8] * xAndLambda[3] * dc0.re - (xAndLambda
    [8] * 0.0 + 0.0 * xAndLambda[3]) * dc0.im) - (xAndLambda[9] * (const_C1_re +
    const_g * dc2.re) - 0.0 * (const_C1_im + const_g * dc2.im))) - (xAndLambda
    [11] * (const_g_re - dc3.re) - 0.0 * (const_g_im - dc3.im))) + Ttrignew) +
                       ((lamX_re * dc5.re - lamX_im * dc5.im) * a.re - (lamX_re *
    dc5.im + lamX_im * dc5.re) * a.im)) + ((lamY_re * dc6.re - lamY_im * dc6.im)
    * dc1.re - (lamY_re * dc6.im + lamY_im * dc6.re) * dc1.im)) + const_mass_re;
  ...
  c_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = muDoubleScalarSin(const_bankmax) * xAndLambda[10] * (const_g * const_mass
    + muDoubleScalarSin(-const_alfamax) * 3420.0);
  ai = muDoubleScalarSin(const_bankmax) * 0.0 * (const_g * const_mass +
    muDoubleScalarSin(-const_alfamax) * 3420.0);
  if (const_mass_im == 0.0) {
  ...
  hamiltonian = ((((((xAndLambda[8] * xAndLambda[3] * dc0.re - (xAndLambda[8] *
    0.0 + 0.0 * xAndLambda[3]) * dc0.im) - (xAndLambda[9] * (const_C1_re +
    const_g * dc6.re) - 0.0 * (const_C1_im + const_g * dc6.im))) - (xAndLambda
    [11] * (const_g_re - dc7.re) - 0.0 * (const_g_im - dc7.im))) + a_re) +
                  ((lamX_re * dc1.re - lamX_im * dc1.im) * dc2.re - (lamX_re *
    dc1.im + lamX_im * dc1.re) * dc2.im)) + ((lamY_re * dc3.re - lamY_im *
    dc3.im) * dc4.re - (lamY_re * dc3.im + lamY_im * dc3.re) * dc4.im)) +
    const_mass_re;
  ...
  d_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = muDoubleScalarSin(const_bankmax * muDoubleScalarSin(banktrig)) *
    xAndLambda[10] * (const_g * const_mass + muDoubleScalarSin(-const_alfamax) *
                      3420.0);
  ...
  e_const_mass.re = const_mass * xAndLambda[3];
  ...
  f_const_mass.re = const_mass * xAndLambda[3];
  ...
  g_const_mass.re = const_mass * xAndLambda[3];
  ...
  h_const_mass.re = const_mass * xAndLambda[3];
  ...
  i_const_mass.re = const_mass * xAndLambda[3];
  ...
  dc0 = gam;
  sec(&dc0);
  const_g_re = xAndLambda[9] * xAndLambda[9];
  const_g_im = xAndLambda[9] * 0.0 + 0.0 * xAndLambda[9];
  v_re = xAndLambda[3] * xAndLambda[3];
  v_im = xAndLambda[3] * 0.0 + 0.0 * xAndLambda[3];
  const_mass_re = xAndLambda[10] * xAndLambda[10];
  lamX_im = xAndLambda[10] * 0.0 + 0.0 * xAndLambda[10];
  a_re = a.re * a.re - a.im * a.im;
  lamY_re = a.re * a.im + a.im * a.re;
  lamY_im = xAndLambda[11] * xAndLambda[10];
  const_C1_re = xAndLambda[11] * 0.0 + 0.0 * xAndLambda[10];
  const_C1_im = lamY_im * dc0.im + const_C1_re * dc0.re;
  dc0.re = (((const_g_re * v_re - const_g_im * v_im) + xAndLambda[11] *
             xAndLambda[11] * (hamiltonian * hamiltonian)) + (const_mass_re *
             a_re - lamX_im * lamY_re) * (lamX_re * lamX_re)) + (lamY_im *
    dc0.re - const_C1_re * dc0.im) * muDoubleScalarSin(-(2.0 * const_bankmax));
  dc0.im = (((const_g_re * v_im + const_g_im * v_re) + (xAndLambda[11] * 0.0 +
              0.0 * xAndLambda[11]) * (hamiltonian * hamiltonian)) +
            (const_mass_re * lamY_re + lamX_im * a_re) * (lamX_re * lamX_re)) +
    const_C1_im * muDoubleScalarSin(-(2.0 * const_bankmax));
  eml_scalar_sqrt(&dc0);
  const_g_re = xAndLambda[9] * xAndLambda[3];
  const_g_im = xAndLambda[9] * 0.0 + 0.0 * xAndLambda[3];
  if (dc0.im == 0.0) {
    if (const_g_im == 0.0) {
  ...
  j_const_mass.re = const_mass * xAndLambda[3];
  ...
  k_const_mass.re = const_mass * xAndLambda[3];
  ...
  l_const_mass.re = const_mass * xAndLambda[3];
  ...
  m_const_mass.re = const_mass * xAndLambda[3];
  ...
  n_const_mass.re = const_mass * xAndLambda[3];
  ...
  o_const_mass.re = const_mass * xAndLambda[3];
  ...
  p_const_mass.re = const_mass * xAndLambda[3];
  ...
  q_const_mass.re = const_mass * xAndLambda[3];
  ...
  r_const_mass.re = const_mass * xAndLambda[3];
  ...
  s_const_mass.re = const_mass * xAndLambda[3];
  ...
  t_const_mass.re = const_mass * xAndLambda[3];
  ...
  u_const_mass.re = const_mass * xAndLambda[3];
  ...
  v_const_mass.re = const_mass * xAndLambda[3];
  ...
  w_const_mass.re = const_mass * xAndLambda[3];
  ...
  x_const_mass.re = const_mass * xAndLambda[3];
  ...
  y_const_mass.re = const_mass * xAndLambda[3];
  ...
  ab_const_mass.re = const_mass * xAndLambda[3];
  ...
  bb_const_mass.re = const_mass * xAndLambda[3];
  ...
  cb_const_mass.re = const_mass * xAndLambda[3];
  ...
  db_const_mass.re = const_mass * xAndLambda[3];
  ...
  eb_const_mass.re = const_mass * xAndLambda[3];
  ...
  fb_const_mass.re = const_mass * xAndLambda[3];
  ...
  gb_const_mass.re = const_mass * xAndLambda[3];
  ...
  hb_const_mass.re = const_mass * xAndLambda[3];
  ...
  ib_const_mass.re = const_mass * xAndLambda[3];
  ...
  jb_const_mass.re = const_mass * xAndLambda[3];
  ...
  kb_const_mass.re = const_mass * xAndLambda[3];
  ...
  lb_const_mass.re = const_mass * xAndLambda[3];
  ...
  mb_const_mass.re = const_mass * xAndLambda[3];
  ...
  nb_const_mass.re = const_mass * xAndLambda[3];
  ...
  ob_const_mass.re = const_mass * xAndLambda[3];
  ...
  pb_const_mass.re = const_mass * xAndLambda[3];
  ...
  qb_const_mass.re = const_mass * xAndLambda[3];
  ...
  rb_const_mass.re = const_mass * xAndLambda[3];
  ...
  sb_const_mass.re = const_mass * xAndLambda[3];
  ...
  tb_const_mass.re = const_mass * xAndLambda[3];
  ...
  ub_const_mass.re = const_mass * xAndLambda[3];
  ...
  vb_const_mass.re = const_mass * xAndLambda[3];
  ...
  wb_const_mass.re = const_mass * xAndLambda[3];
  ...
  xb_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = -(1560.0 * xAndLambda[9] * muDoubleScalarCos(-const_alfamax));
  ...
  ar = muDoubleScalarSin(-const_alfamax) * (1560.0 * xAndLambda[11]) *
  ...
  ar = muDoubleScalarSin(-const_alfamax) * (1560.0 * xAndLambda[10]) *
  ...
  yb_const_mass.re = const_mass * xAndLambda[3];
  ...
  ac_const_mass.re = const_mass * xAndLambda[3];
  ...
  bc_const_mass.re = const_mass * xAndLambda[3];
  ...
  cc_const_mass.re = const_mass * xAndLambda[3];
  ...
  dc_const_mass.re = const_mass * xAndLambda[3];
  ...
  ec_const_mass.re = const_mass * xAndLambda[3];
  ...
  fc_const_mass.re = const_mass * xAndLambda[3];
  ...
  gc_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * (1560.0 *
    xAndLambda[11]) * muDoubleScalarCos(-const_bankmax);
  ...
  const_mass_im = hamiltonian * a.im + const_mass_im * a.re;
  ar = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * (1560.0 *
    xAndLambda[10]) * muDoubleScalarSin(-const_bankmax);
  ai = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * 0.0 *
    muDoubleScalarSin(-const_bankmax);
  if (const_mass_im == 0.0) {
    if (ai == 0.0) {
  ...
  hc_const_mass.re = const_mass * xAndLambda[3];
  ...
  ic_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * (1560.0 *
    xAndLambda[11]) * muDoubleScalarCos(const_bankmax * muDoubleScalarSin
    (banktrig));
  ai = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * 0.0 *
    muDoubleScalarCos(const_bankmax * muDoubleScalarSin(banktrig));
  hamiltonian = const_mass * xAndLambda[3];
  ...
  const_mass_im = hamiltonian * a.im + const_mass_im * a.re;
  ar = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * (1560.0 *
    xAndLambda[10]) * muDoubleScalarSin(const_bankmax * muDoubleScalarSin
    (banktrig));
  ai = muDoubleScalarSin(const_alfamax * muDoubleScalarSin(alfatrig)) * 0.0 *
    muDoubleScalarSin(const_bankmax * muDoubleScalarSin(banktrig));
  if (const_mass_im == 0.0) {
  ...
  jc_const_mass.re = const_mass * xAndLambda[3];
  ...
  kc_const_mass.re = const_mass * xAndLambda[3];
  ...
  lc_const_mass.re = const_mass * xAndLambda[3];
  ...
  mc_const_mass.re = const_mass * xAndLambda[3];
  ...
  nc_const_mass.re = const_mass * xAndLambda[3];
  ...
  oc_const_mass.re = const_mass * xAndLambda[3];
  ...
  pc_const_mass.re = const_mass * xAndLambda[3];
  ...
  qc_const_mass.re = const_mass * xAndLambda[3];
  ...
  rc_const_mass.re = const_mass * xAndLambda[3];
  ...
  sc_const_mass.re = const_mass * xAndLambda[3];
  ...
  tc_const_mass.re = const_mass * xAndLambda[3];
  ...
  uc_const_mass.re = const_mass * xAndLambda[3];
  ...
  vc_const_mass.re = const_mass * xAndLambda[3];
  ...
  ar = (const_C1 * (xAndLambda[3] * xAndLambda[3]) + dc6.re) - muDoubleScalarCos
    (const_alfamax * muDoubleScalarSin(alfatrig)) * (1560.0 * muDoubleScalarSin
    (Ttrignew) + 1860.0);
  ai = const_C1 * (xAndLambda[3] * 0.0 + 0.0 * xAndLambda[3]) + dc6.im;
  if (ai == 0.0) {
    const_C1_re = ar / const_mass;
    const_C1_im = 0.0;
  } else if (ar == 0.0) {
  ...
  wc_const_mass.re = const_mass * xAndLambda[3];
  ...
  hamiltonian = ((((((xAndLambda[8] * xAndLambda[3] * dc0.re - (xAndLambda[8] *
    0.0 + 0.0 * xAndLambda[3]) * dc0.im) - (xAndLambda[9] * (const_C1_re +
    const_g * dc5.re) - 0.0 * (const_C1_im + const_g * dc5.im))) - (xAndLambda
    [11] * (const_g_re - dc6.re) - 0.0 * (const_g_im - dc6.im))) + a_re) +
                  ((lamX_re * dc1.re - lamX_im * dc1.im) * dc2.re - (lamX_re *
    dc1.im + lamX_im * dc1.re) * dc2.im)) + ((lamY_re * dc3.re - lamY_im *
    dc3.im) * psii.re - (lamY_re * dc3.im + lamY_im * dc3.re) * psii.im)) +
    const_mass_re;
