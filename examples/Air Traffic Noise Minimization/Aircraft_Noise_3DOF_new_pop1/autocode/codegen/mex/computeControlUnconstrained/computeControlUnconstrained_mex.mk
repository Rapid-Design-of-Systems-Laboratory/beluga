START_DIR = /home/mall/mjgrant/trajProblems/Friends/Janav/Aircraft_Noise_3DOF_new_pop1/autocode

MATLAB_ROOT = /apps/rhel6/MATLAB/R2013a
MAKEFILE = computeControlUnconstrained_mex.mk

include computeControlUnconstrained_mex.mki


SRC_FILES =  \
	computeControlUnconstrained_data.c \
...
MEX_FILE_NAME_WO_EXT = computeControlUnconstrained_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/computeControlUnconstrained"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/computeControlUnconstrained/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/computeControlUnconstrained/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/computeControlUnconstrained/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
