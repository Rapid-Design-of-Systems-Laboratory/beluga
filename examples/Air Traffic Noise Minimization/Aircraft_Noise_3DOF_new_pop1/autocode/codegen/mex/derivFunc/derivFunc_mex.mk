...
MAKEFILE = derivFunc_mex.mk

include derivFunc_mex.mki
...
MEX_FILE_NAME_WO_EXT = derivFunc_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/derivFunc"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFunc/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFunc/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFunc/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
