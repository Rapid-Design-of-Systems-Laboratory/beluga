...
extern void computeControlUnconstrained(const real_T xAndLambda_data[12], real_T const_C1, real_T const_C2, real_T const_alfamax, real_T const_bankmax, real_T const_g, real_T const_mass, real_T *banktrigSave, real_T *alfatrigSave, real_T *TtrignewSave, real_T *hamiltonianSave);
