...
MAKEFILE = derivFuncRegion_mex.mk

include derivFuncRegion_mex.mki
...
MEX_FILE_NAME_WO_EXT = derivFuncRegion_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/derivFuncRegion"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFuncRegion/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFuncRegion/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/derivFuncRegion/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
