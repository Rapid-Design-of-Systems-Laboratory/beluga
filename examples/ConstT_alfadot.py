...
def get_problem():
    ...
    problem.state('h','v*sin(gam)+ ep*(cos(alfadottrig))','m')   \
           ...
           .state('alfatrig','(5*pi/180*sin(alfadottrig))/(10*pi/180*cos(alfatrig))','rad')
...
#     problem.constant('mdotf',15.5*0.05,'kg/s') # Fuel Mass Flow Rate of Vehicle, kg
    problem.constant('T',2668932,'kg*m/s^2') # Constant Thrust of Vehcicle, kgm/s^2
    problem.constant('G0',9.81,'m/s^2') # Gravitational Constant at the surface of Earth
    ...
    problem.guess.setup('auto',start=[50000,0,4000,-90*pi/180,127005,0],costate_guess=0.1)
