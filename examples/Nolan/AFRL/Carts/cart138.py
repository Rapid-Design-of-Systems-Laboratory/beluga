if __name__ == "__main__":
 ...
 \
    ...
    problem.bvp_solver = algorithms.MultipleShooting(derivative_method='csd', tolerance=1e-4, max_iterations=1000, verbose=True, cached=False, number_arcs=32)
    ...
    problem.steps.add_step().num_cases(16) \
        .const('xb', 5) \
        .const('yb', 20)
