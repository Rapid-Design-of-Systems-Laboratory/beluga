if __name__ == "__main__":
    ...
    problem.cost['path'] = Expression('1*sin(w)**2', 's')
 ...
 \
    ...
    problem.guess.setup('auto', start=[0, 0, 0, 0, 0, 0], time_integrate=1, costate_guess=[0, 0, 0, 0, 0, 0])
