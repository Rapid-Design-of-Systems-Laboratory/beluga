...
# Define constraints
ocp_indirect.constraints().initial_constraint('x1 - x1_0', 'nd')
ocp_indirect.constraints().initial_constraint('x2 - x2_0', 'nd')
ocp_indirect.constraints().initial_constraint('t', 'nd')
ocp_indirect.path_constraint('u', 'rad', lower='-2', upper='2', activator='epsilon1', method='epstrig')
ocp_indirect.constraints().terminal_constraint('t - 1', 'nd')
