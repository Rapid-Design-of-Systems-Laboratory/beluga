...
plots = BelugaPlot('./data.dill',default_sol=-1,default_step=-1, renderer='toyplot')
renderer = ToyPlot(backend='png')
# plots = BelugaPlot('./phu_2k5_eps4.dill',default_sol=-1,default_step=-1, renderer=renderer)
#
